"""
The main file for preprocessing library
"""
...
def input_transform(image_size: tuple[float, float] = (322, 322)) -> T.Compose:
...
class Preprocessor:
    """Preprocessor class with main function for preprocessing"""

    def __init__(self, image_size: tuple[float, float] = (322, 322)) -> None:
        """Creation of transform pipeline object for preprocessing"""
